...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴显示成绩类别：犯规、一般成绩、优秀成绩；纵轴显示次数。甲的柱子：犯规约3次（实际根据数据计算），一般成绩约4次？乙的优秀成绩约4次等。具体结构如描述。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 左侧为“可以通过点O作AD的垂线……”的文字提示；右侧为“也可以连接EO并延长……”的文字提示，两个对话框分别对应两种证法思路。
-->