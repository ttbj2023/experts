...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴显示成绩类别（犯规、一般成绩、优秀成绩），纵轴显示次数。图中甲的犯规次数约3，一般成绩约4，优秀成绩约3；乙的犯规次数约1，一般成绩约2，优秀成绩约4。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 四边形ABCD关于点O对称，圆O与BC相切于E点。左侧提示为过点A作AD的垂线……右侧提示为连接EO并延长…… -->