...
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 直角三角形ABC示意图，∠C为直角，CD⊥AB于点D，标注顶点A、B、C、D的位置及反比例函数相关标记（此处为题目配图）
-->  

15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．  
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 矩形ABCD示意图，A在左上角、B右上角、C右下角、D左下角；Rt△ABE和Rt△CDF分别位于矩形内，标注各顶点及对应全等的三角形关系
-->  

16.（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是__．  
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 扇形OAB示意图，圆心为O、标注点A、B的位置及圆心角的度数（260°）
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 点P在直线l外的示意图，标注点P、直线l及所作的平行线
-->  
