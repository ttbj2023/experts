...
5. （2分）实数$-a$, $a$, $\frac{1}{a}$在数轴上对应点的位置如图所示。下列四个点中，表示1的点可能是（ ）
   <!-- IMAGE_PLACEHOLDER
   type: 示意图
   description: 数轴示意图，从左到右依次标记P(-a)、Q(a)、R、S(1/a)，各点位置关系清晰
   -->
   A. P 
   B. Q 
   C. R 
...
7. （2分）已知一组数据8, 10, 12, 9, 11，这组数据的平均数是 ___ .
