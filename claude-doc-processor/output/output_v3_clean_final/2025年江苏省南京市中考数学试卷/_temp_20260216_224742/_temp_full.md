...
5. （2分）实数$-a$，$a$，$\frac{1}{a}$在数轴上对应点的位置如图所示. 下列四个点中，表示1的点可能是（ ）
    <!-- IMAGE_PLACEHOLDER
    type: 示意图
    description: 数轴图，从左到右依次标记P、Q、R、S四个点，分别对应- a、a、$\frac{1}{a}$的位置。数轴上标注了P(-a)、Q(a)、R($\frac{1}{a}$)等关键点。
    -->
    A. P B. Q C. R D. S
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中的直线y=2x+4，过第一、二象限，与y轴交点在(0,4)，点P位于第一象限内某处
-->
A. 1 B. 2 C. 3 D. 4
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸/示意图
description: 圆形古钱币示意图，内部有边长10 mm的正方形孔，圆心到正方形右侧边的距离标注为7 mm（从图中虚线标注可见）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 次数轴从0到5，甲的“犯规”柱高度约3，“一般成绩”柱高度4，“优秀成绩”柱高度约3.5；乙的“犯规”柱高度约1，“一般成绩”柱无（或高度为0），“优秀成绩”柱高度约4。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)，圆心为O，有半径9的OA、6的OB，弧AD和弧BC，标注尺寸信息
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(2)，矩形ABCD内部有弧形曲线，标注边长a和b
-->
<figure style="text-align: center;">
  <!-- 这里原本是图片位置 -->
</figure>
