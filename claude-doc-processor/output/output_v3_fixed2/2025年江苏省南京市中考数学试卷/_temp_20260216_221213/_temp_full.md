...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴图，从左到右依次标记P、Q、R、S四个点，分别对应 -a, a, $\frac{1}{a}$ 的位置。具体为：P在-a处，Q在a处，R位于a与$\frac{1}{a}$之间，S在$\frac{1}{a}$右侧。
-->  
   A. P B. Q C. R D. S  
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸/示意图
description: 圆形古钱币示意图，圆内有一个边长标注为10的正方形孔，圆外标注半径相关尺寸7
-->
...
<!-- IMAGE_PLACEHOLDER
type: 图表/图形
description: 直角三角形ABC示意图，点C为直角顶点，CD⊥AB于D点，标注了A、B、C、D四个位置关系
-->  

15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为______．  
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 矩形ABCD示意图，点E、F在矩形内部，标注了Rt△ABE和Rt△CDF全等关系及各顶点位置
-->  

16.（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是__．  
<!-- IMAGE_PLACEHOLDER
type: 图表/图形
description: 扇形OAB示意图，标注了圆心O、端点A和B及圆心角260°的位置关系
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 点P在直线l外的示意图，标注了点P和直线l的位置关系
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 成绩分类的柱状图，横轴为成绩类别（犯规、一般成绩、优秀成绩），纵轴为次数。图中显示甲在犯规类有1次，乙在犯规类有0次；一般成绩中甲有4次，乙有3次；优秀成绩中甲有3次，乙有4次。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 左侧示意图显示过点A作AD的垂线，右侧示意图连接EO并延长。图中包含平行四边形ABCD、圆心O、切点E等几何元素。-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 纸杯展开后的扇环示意图，包含O点，OA和OB为半径，分别标注9cm和6cm，弧AD和BC，ABCD为剩余部分
-->  
