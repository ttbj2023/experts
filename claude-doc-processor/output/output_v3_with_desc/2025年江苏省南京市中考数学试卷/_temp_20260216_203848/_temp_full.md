...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴图，从左到右依次标记P(-a)、Q(a)、R(1/a)、S的位置，各点用黑点标注
-->
A. P B. Q C. R D. S
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中显示直线y=2x+4，原点O标记清晰，点P位于第一象限内某位置
-->
A. 1 B. 2 C. 3 D. 4
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直角三角形ACB，点C在上方，A和B在底边两端，CD垂直AB于D处，标注各顶点和垂足。
-->  

15. （2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．  
<!-- IMAGE_PLACEHOLDER
type: 矩形内的几何图形
description: 矩形ABCD，点A在左上角、B在右上角、C在右下角、D在左下角。Rt△ABE和Rt△CDF分别以A、D为直角顶点，标注各点和全等关系。
-->  

16. （2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是 ___．  
<!-- IMAGE_PLACEHOLDER
type: 扇形示意图
description: 扇形OAB，圆心O，顶点A和B在圆弧两端，圆心角标注为260°，点P位于扇形内部区域。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 直线l和外部一点P，表示需要过P作平行于l的直线。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表（条形图）
description: 条形统计图，横轴为“成绩”类别包括“犯规”“一般成绩”“优秀成绩”，纵轴为次数（0-5）。图中显示甲在“犯规”约3次，“一般成绩”约4次，“优秀成绩”约3次；乙在“犯规”约1次，“一般成绩”约2次，“优秀成绩”约4次。具体柱状高度对应数据。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 平行四边形ABCD，O为对称中心（对角线交点），BC与圆O相切于E点。图中标注了平行四边形的顶点和圆的位置关系。
-->  
选择其中一位同学的想法，完成证明。
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内含圆心为O的圆，圆与边AB相切于某点，E点在BC边上标注
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角，B右下角，C右上角，D左上角，动点P在AB边上，三角形APD内有展开的画面图案
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系示意图，北方向向上，东向右，A点在上方偏左位置，B点在下方偏右位置，标注南偏东30°角，P为AB中点，C从A正南方向出发，D从B正东方向出发，C、P、D共线
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)，左侧有A、B、O点，标注弧AD，OB长度6cm，OA长度9cm等几何图形；右侧是图(2)的矩形展开图，标注a和b边。
-->
