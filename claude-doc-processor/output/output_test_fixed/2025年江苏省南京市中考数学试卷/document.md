...
5. （2分）实数$-a$，$a$，$\frac{1}{a}$在数轴上对应点的位置如图所示. 下列四个点中，表示1的点可能是（ ）
   <!-- IMAGE_PLACEHOLDER
   type: 示意图
   description: 数轴图，从左到右依次标注P、Q、R、S四点，分别对应- a, a, 1/a的位置，其中P在最左侧，然后是Q在a处，R在1/a附近，S在最右侧
   -->
   A. P B. Q C. R D. S
...
10.(2分)已知x=2是方程$\frac{1}{x-a}+\frac{2a}{a-x}=\frac{1}{x}$的解，则a的值是___．
11.(2分)设方程$x^2+2x-9=0$的正根介于整数m与m+1之间，则m=___．
12.(2分)一枚圆形古钱币的正中间是一个正方形孔，它的部分尺寸（单位：mm）如图，这枚古钱币的半径为___ m.
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 圆形古钱币示意图，内部有边长10的正方形孔，圆外标注7的尺寸
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内有一个圆心为O的圆，圆与边AB、BC、CD、DA分别相切于点E等位置（根据原图描述）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，其中A在左下角，B在右下角，C在右上角，D在左上角，点P在边AB上移动，形成三角形ADP等区域（根据题目描述）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 方位示意图
description: 坐标系中A在上方，B在南偏东30°方向，标注北和东方向箭头，点P在AB中点位置，C从A正南出发，D从B正东出发，形成三角形ACP等结构（根据题目描述）
-->
