...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 直角三角形ABC，其中∠C为直角，CD垂直于AB于点D，标注顶点A、B、C、D的位置
-->
14. （2分）已知反比例函数$y = \frac{6}{x}$，则当1≤x≤3时，x的最小值是________．

<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 矩形ABCD，点E、F在矩形内，Rt△ABE和Rt△CDF全等，标注各顶点和对应边的关系
-->
15. （2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 扇形示意图
description: 扇形OAB的圆心角为260°，标注点O、A、B的位置及圆心角的度数
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 点P在直线l外的位置，标注直线l和点P的位置关系
-->
