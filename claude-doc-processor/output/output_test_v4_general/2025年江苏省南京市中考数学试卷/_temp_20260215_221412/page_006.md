...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 纸杯尺寸示意图，包含图(1)，左侧显示纸杯的立体图，标注了A、B点及半径9和6，右侧是展开后的扇环结构。具体包括：左图为纸杯侧面展开前，有圆心O，弧AD，弧BC，线段OA=OB=9cm，OC=OD=6cm；右图为展开后矩形内的两个扇形轮廓。
-->
(1) \widehat{AD}的长为___ cm，$OB = $ ___ cm。  
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(2)，显示矩形纸片ABCD的示意图，其中包含两个弧线（上弧和下弧），标注了边长a和b。
-->
