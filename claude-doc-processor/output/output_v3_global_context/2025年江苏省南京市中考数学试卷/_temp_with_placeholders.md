...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴图，从左到右依次标注P、Q、R、S四个点，分别对应 -a, a, 1/a 的位置，其中P在最左侧，然后是Q(-a)，接着R(a)，再是S(1/a)
-->
A. P B. Q C. R D. S
...
10. (2分) 已知x=2是方程$x - \frac{a}{1+2a} = \frac{1}{a} - x$的解，则a的值是___ .  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 矩形ABCD内，Rt△ABE≌Rt△CDF，标注各顶点和对应线段位置
-->
15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 扇形示意图
description: 扇形OAB，圆心角260°，标注点O、A、B的位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 点P在直线l外，标注点P和直线l的位置关系
-->
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴显示成绩类别：犯规、一般成绩、优秀成绩；纵轴显示次数。甲的犯规次数约3，“一般成绩”约4次，“优秀成绩”约3次；乙的“犯规”约1次，“一般成绩”约3次，“优秀成绩”约4次。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 科学插图
description: 平行四边形ABCD示意图，O为对称中心，BC与圆O相切于E点，图中显示相关几何关系用于证明。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内有一个圆O，圆与边AB相切于点E，标注各顶点和圆心位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角，B在右下角，C在右上角，D在左上角，动点P在边AB上，连接DP形成三角形区域表示展开画面
-->
...
<!-- IMAGE_PLACEHOLDER
type: 方位示意图
description: 坐标系中A在上方，B在南偏东30°方向，标注北、东方向箭头，点A、B、C、P、D的位置关系，其中C在A正南方向，D在B正东方向，P为AB中点，C、P、D共线
-->
