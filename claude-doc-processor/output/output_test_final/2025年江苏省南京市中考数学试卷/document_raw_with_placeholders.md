...
5. (2分) 实数 $-a$, $a$, $\frac{1}{a}$ 在数轴上对应点的位置如图所示. 下列四个点中，表示1的点可能是（ ）  
   <!-- IMAGE_PLACEHOLDER
   type: 示意图
   description: 数轴示意图，从左到右依次标注P、Q、R、S四点，分别对应- a, a, $\frac{1}{a}$ 和$\frac{1}{a}$的位置，各点用黑点表示
   -->
   A. P  
   B. Q  
   C. R  
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中的直线y=2x+4和点P的位置标注
-->
A. 1 B. 2 C. 3 D. 4
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸/示意图
description: 圆形古钱币示意图，包含内接正方形，标注边长10和7等尺寸
-->
...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 次数-成绩的柱状图，横轴显示“犯规”“一般成绩”“优秀成绩”三类，纵轴为次数。甲在“犯规”约3次，“一般成绩”约4次，“优秀成绩”约3次；乙在“犯规”约1次，“一般成绩”约0次（或根据数据调整），“优秀成绩”约4次。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 左侧显示“可以通过点O作AD的垂线……”，右侧显示“也可以连接EO并延长……”
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内有一个圆O，圆与边AB相切于某点，E在BC边上
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD，A在左下角，B在右下角，C在右上角，D在左上角，点P在AB边上，形成三角形ADP
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系中，A在上方，B在南偏东30°方向，AB=40km，P是AB中点，C从A正南方向出发，D从B正东方向出发，C、P、D共线
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)，左侧有标注9的线段OA和OB，B点处有半径6的圆弧，右侧图(2)是矩形纸片ABCD的展开示意图，包含a、b标注的边长
-->  
