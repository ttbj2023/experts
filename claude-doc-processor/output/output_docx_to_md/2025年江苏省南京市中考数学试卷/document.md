...
7．（2分）已知一组数据8，10，12，9，11，这组数据的平均数是　     　 ．
...
12．（2分）一枚圆形古钱币的正中间是一个正方形孔，它的部分尺寸（单位：mm）如图，这枚古钱币的半径为　        　 m．

![image11.png](images/image11.png)

13．（2分）如图，在Rt△ABC中，∠ACB＝90°，CD是边AB上的高，，则的值是　                　 ．
...
16．（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是 　                　 ．
...
|  | 第1次测试 | 第1次测试 | 第1次测试 | 第2次测试 | 第2次测试 | 第2次测试 | 第3次测试 | 第3次测试 | 第3次测试 |
|---|---|---|---|---|---|---|---|---|---|
