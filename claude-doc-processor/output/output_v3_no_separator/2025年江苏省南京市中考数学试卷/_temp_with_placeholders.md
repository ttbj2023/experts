...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标注P(-a)、Q(a)、R(1/a)、S，各点位置用线段和标记点表示
-->
   A. P
   B. Q
   C. R
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 圆形古钱币示意图，中间有边长10mm的正方形孔，圆外标注半径7mm（从圆心到圆周的线段）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直角三角形ABC，其中C是直角顶点，CD垂直于AB交于D点，标注各顶点和垂足位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 矩形ABCD，对角线AC和BD相交于点O（假设），点E在对角线AC上，点F在对角线BD上，分别作直角三角形ABE和CDF，标注各顶点和全等关系
-->
16. （2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是___．
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 扇形OAB，圆心角260°，标注圆心O、端点A和B，以及内部一点P的位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直线l和外部一点P，标注直线l和点P的位置关系
-->
...
注：×表示犯规。  
将上述成绩分成“犯规”“一般成绩”（5.75m以下）和“优秀成绩”（5.75m及以上）三类，并绘制条形统计图。  
（1）补全条形统计图。  
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴为成绩类别（犯规、一般成绩、优秀成绩），纵轴为次数。甲的“犯规”柱高度约3，“一般成绩”约4，“优秀成绩”约3；乙的“犯规”柱高度约1，“一般成绩”约4，“优秀成绩”约3。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 关于平行四边形ABCD对称中心O的两个证明思路示意图：左侧为“过点O作AD的垂线”，右侧为“连接EO并延长”。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内含圆O，E为BC边上的点，标注各顶点A、B、C、D及圆心O的位置
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，标注顶点A、B、C、D及动点P在边AB上的位置，形成三角形ADP区域表示展开画面
-->  
（2）当展开的画面面积达到电子屏面积的4时开始播放广告语，播放时间持续3s，求播放结束时展开的画面面积。  
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，标注顶点A、B、C、D及三角形ADP区域（画面展开部分）
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系示意图，标注A、B位置（B在A南偏东30°方向），P为AB中点，C从A正南出发，D从B正东出发，三点C、P、D共线
-->  

26.（9分）（1）将函数$y = -x^2 + 2$的图象向右平移2个单位长度，平移后的函数图象与y轴交点的纵坐标是___。  
<!-- IMAGE_PLACEHOLDER
type: 函数图像示意图
description: 原函数抛物线及向右平移2个单位的抛物线，标注与y轴交点位置
-->

---

(2) 平移函数$y = -x^2 + 2$的图象，在这个过程中，它的顶点都在一次函数$y = kx + 2$的图象上。设平移后的函数图象的顶点为P，横坐标为m，与y轴交点的纵坐标为n，n随m的变化而变化。
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)显示纸杯的侧面展开图，包含扇形OAD和OBC，标注了A、B点，OA=9cm，OB=6cm等尺寸信息
-->
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(2)显示矩形纸片ABCD的展开示意图，标注了a和b的边长
-->
