...
![图片：数轴图，从左到右依次标记P(-a)、Q(a)、R(中间某点)、S($\frac{1}{a}$)，各点位置示意](./images/image5.png)
...
![图片：坐标系中显示直线y=2x+4，原点O，以及点P的位置](./images/image6.png)
...
![图片：圆形古钱币示意图，内部有边长10 mm的正方形孔，圆外标注半径相关尺寸7 mm（从圆心到正方形边的距离）](./images/image9.png)

13. (2分) 如图，在Rt△ABC中，∠ACB=90°，CD是边AB上的高，$\frac{AD}{CD}=\frac{1}{2}$，则$\frac{S_{\triangle ACD}}{S_{\triangle ABC}}$的值是___ .

![图片：直角三角形ABC示意图，∠ACB=90°，CD为AB上的高，标注AD/CD = 1/2，求面积比](./images/image10.png)



已知反比例函数$y=\frac{6}{x}$，则当1≤x≤3时，x的最小值是______。

![图片：直角三角形示意图，标注点C、A、D、B，其中CD垂直于AB，形成两个直角三角形ACD和BCD](./images/image12.png)


15. （2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF。若AB=25，AD=30，AE=15，则EF的长为______。

![图片：矩形ABCD示意图，内部有Rt△ABE和Rt△CDF，分别以A为公共顶点、C为公共顶点，标注各点和线段关系](./images/image15.png)


16. （2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是___。

![图片：扇形OAB，圆心角260°，标注点O、A、B及圆心角角度](./images/image16.png)
...
![图片：点P在直线l外的示意图，标注点P和直线l的位置关系](./images/image18.png)
...
![图片：横轴显示成绩类别：犯规、一般成绩、优秀成绩；纵轴显示次数，甲的犯规约2次，一般成绩4次，优秀成绩3次；乙的犯规0次，一般成绩3次，优秀成绩4次（根据数据计算）](./images/image21.png)
...
![图片：左侧人物说“可以通过点O作AD的垂线……”，右侧人物说“也可以连接EO并延长……”](./images/image22.png)



(2) 当AB与⊙O相切时，□ABCD是菱形吗？说明理由。

![图片：平行四边形ABCD内含圆O，圆与边AB相切于某点，标注顶点A、B、C、D及圆心O的位置](./images/image23.png)
...
![图片：长方形电子屏ABCD示意图，其中A在左下角，B在右下角，C在右上角，D在左上角，动点P在AB边上运动，形成三角形APD作为画面展开区域](./images/image25.png)
...
![图片：方向标（北向上，东向右），码头A、B位置关系：B在A南偏东30°方向，距离40km；灯塔P在AB中点。轮船甲从A沿正南到C，乙从B沿正东到D，三点C、P、D共线](./images/image27.png)
...
![图片：矩形纸片ABCD的平面展开图，长为b，宽为a（a≤b），B、C在底边，A、D在上边，弧AD与底边BC的位置关系示意](./images/image28.png)
