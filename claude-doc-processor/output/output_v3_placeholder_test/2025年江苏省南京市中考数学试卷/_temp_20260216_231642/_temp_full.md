...
5. (2分) 实数$-a$，$a$，$\frac{1}{a}$在数轴上对应点的位置如图所示。下列四个点中，表示1的点可能是（ ）  
   <!-- IMAGE_PLACEHOLDER
   type: 示意图
   description: 数轴图，从左到右依次标记P(-a)、Q(a)、R(中间某点)、S($\frac{1}{a}$)，各点位置示意
   -->
   A. P B. Q C. R D. S  
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直角三角形ABC示意图，∠ACB=90°，CD为AB上的高，标注AD/CD = 1/2，求面积比
-->
```
...
20.（7分）已知$\frac{1}{a}<b<0$，试比较$\frac{1}{a^2}$与$\frac{1}{b^2}$的大小.
...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 横轴显示成绩类别：犯规、一般成绩、优秀成绩；纵轴显示次数，甲的犯规约2次，一般成绩4次，优秀成绩3次；乙的犯规0次，一般成绩3次，优秀成绩4次（根据数据计算）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 纸杯侧面展开图，包含扇形OAD和OBC，OA=OD=9cm，OB=OC=6cm，弧AD和弧BC分别标注，点A、B、C、D的位置关系清晰
-->  
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形纸片ABCD的平面展开图，长为b，宽为a（a≤b），B、C在底边，A、D在上边，弧AD与底边BC的位置关系示意
-->  
