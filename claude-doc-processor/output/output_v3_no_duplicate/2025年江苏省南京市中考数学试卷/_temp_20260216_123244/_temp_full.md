...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴图，从左到右依次标记P、Q、R、S四个点，其中P对应-a的位置，Q对应a的位置，R对应$\frac{1}{a}$的位置，S在R右侧。数轴上各点的位置关系为：P在最左侧，然后是Q（在原点右侧），接着是R，最后是S。
-->
A. P B. Q C. R D. S  

6. （2分）如图，在平面直角坐标系中，已知下列变换：
①沿y轴翻折；②沿函数$y=x+2$的图象翻折；
③绕原点按顺时针方向旋转45°；④绕点(1, -1)按顺时针方向旋转90°。其中，能使函数$y=2x+4$的图象经过一种变换后过点P(2, 2)的个数是（ ）

---

<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中显示直线y=2x+4，过第一、二象限，与y轴交点在(0,4)，点P位于第一象限内某位置
-->
A.1 B.2 C.3 D.4
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 圆形古钱币示意图，内部有边长10 mm的正方形孔，圆心到正方形右侧边的距离标注为7 mm（从虚线测量）
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴为“成绩类别”（犯规、一般成绩、优秀成绩），纵轴为次数（0-5）。其中“犯规”类别下甲有3次，乙有1次；“一般成绩”下甲有4次，乙有3次；“优秀成绩”下甲有3次，乙有4次。图中用不同颜色区分甲和乙的柱子。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 平行四边形ABCD，O是对称中心，连接各顶点和对称中心。BC与圆O相切于E点，图中显示过点A作AD的垂线或连接EO并延长等思路。
-->
