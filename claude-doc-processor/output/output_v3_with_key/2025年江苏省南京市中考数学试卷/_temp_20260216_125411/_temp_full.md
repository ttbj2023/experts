...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标注P(-a)、Q(a)、R(1/a)、S，各点位置关系为P在最左侧，然后Q在a处（位于原点右侧），接着R在1/a处（位于正数区域且大于a），最后是S。
-->
   A. P B. Q C. R D. S  
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 圆形古钱币示意图，中间有边长10 mm的正方形孔，圆外标注半径相关尺寸7 mm（从圆心到某点的距离）
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD示意图，内部包含圆O，点E在BC边上
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角，B在右下角，C在右上角，D在左上角，点P在AB边上，形成三角形APD区域表示画面展开部分
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系示意图，北方向向上，东方向向右，点A在左上方，B在南偏东30°方向，P在AB中点，C从A正南方向出发，D从B正东方向出发，C、P、D共线
-->
...
(2) 平移函数$y = -x^2 + 2$的图像，在这个过程中，它的顶点都在一次函数$y = kx + 2$的图象上。设平移后的函数图象的顶点为$P$，横坐标为$m$，与y轴交点的纵坐标为$n$，n随m的变化而变化。
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 纸杯展开示意图，包含两个扇形OAD和OBC，标注A、B点及半径9cm等尺寸信息，图(1)所示
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形纸片示意图，标注边长a,b及扇环形状，图(2)所示
-->
<figure style="text-align: center;">
  <!-- 图片占位符 -->
</figure>
