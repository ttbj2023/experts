...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 菱形ABCD内含圆O，E为BC边上的点，标注各顶点A、B、C、D及圆心O的位置关系
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，标注A、B、C、D四点位置及动点P在AB边上，形成三角形ADP区域表示画面展开部分
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 方位示意图
description: 坐标系中A点在上方偏左位置，B在南偏东30°方向，标注北、东方向箭头，显示A到B的距离40km，P为AB中点，C从A正南方向出发，D从B正东方向出发，C、P、D共线
-->  
