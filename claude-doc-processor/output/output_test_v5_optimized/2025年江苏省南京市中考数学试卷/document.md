...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴上标注了点P、Q、R、S，分别对应- a、a、1/a的位置，从左到右依次为P(-a)、Q(a)、R、S(1/a)
-->  
   A. P  
   B. Q  
   C. R  
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像坐标系的示意图
description: 坐标系中绘制直线y=2x+4，包含原点O和点P的位置标注
-->
A. 1 B. 2 C. 3 D. 4
