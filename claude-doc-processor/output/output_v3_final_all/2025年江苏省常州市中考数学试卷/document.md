...
![图片：数轴图，刻度从-3到3，标记点P在2的位置，箭头向右](./images/image1.png)
...
![图片：圆形图，圆心O，直径AB水平，CD竖直相交于O，点C在上方，B在右方，A在左方，D在下方](./images/image9.png)

A. $\frac{\pi}{4}$ B. $\frac{\pi}{2}$ C. π D. 2π

5．(2分)如图，在Rt△ABC中，∠A=90°，AB=3，AC=4，则sinB的值是（ ）
    
![图片：直角三角形图，∠A为直角，标注边AB=3，AC=4，BC为斜边](./images/image12.png)
...
![图片：菱形ABCD示意图，对角线AC和BD相交于点O，标注各顶点A、B、C、D的位置及角度∠ABD=30°](./images/image17.png)
...
![图片：两块相同直角三角尺摆放示意图，显示AB和CD的位置关系及角度标注](./images/image18.png)
...
![图片：左侧第一个坐标系图A，显示y轴1800和900刻度，直线从(0,1800)下降至x轴；右侧第二个坐标系图B，同样结构但曲线在900处拐点不同](./images/image20.png)


![图片：左侧第三个坐标系图C，y轴1800到600，直线从(0,1800)下降至600处转折后继续；右侧第四个坐标系图D，结构与C类似但转折点位置不同](./images/image22.png)
...
![图片：平行线AB和CD，点A在AB上，AC垂直于AD形成直角，标注∠ACD=50°，求∠α的度数](./images/image25.png)

16. （2分）如图，在▱ABCD中，E是AD上一点，DE=2AE，CE、BA的延长线相交于点F，若AB=2，则AF= ___ .

![图片：平行四边形ABCD，A-B-C-D顺序，E在AD上且DE=2AE，连接CE交BA延长线于F，标注各边关系和点位置](./images/image26.png)



17.（2分）如图，AB是⊙O的直径，CD是⊙O的弦．若∠DCB=45°，AD=1，则AB= ______．

![图片：圆形几何示意图，显示圆心O，直径AB，弦CD，点D在圆周上，连接相关线段构成图形](./images/image27.png)


18.（2分）如图，在△ABC中，tanC=4/3，D是边BC上一点，将△ACD沿AD翻折得到△AED使线段AE、BC相交于点F，若CF=5，EF=2，则AC= ______．

![图片：三角形几何示意图，包含△ABC，点D在BC边上，通过折叠形成△AED，标注交点F及线段长度CF=5、EF=2](./images/image29.png)
...
![图片：数轴示意图，标注解集范围，包含关键点及区间表示](./images/image32.png)
...
![图片：三角形ABC示意图，A在上方，B、C在底边两端，D在BC上靠近B，E在BC上靠近C，连接AD、AE](./images/image35.png)
...
![图片：平面直角坐标系示意图，包含一次函数直线和反比例函数曲线，交于A(1,n)、B(-3,-2)，与y轴交于C点，坐标原点O在中心](./images/image37.png)
...
![图片：四边形ABCD示意图，顶点A、B、C、D，对角线AC和BD相交于点O](./images/image38.png)
...
![图片：平面直角坐标系中的直线y=-3/2 x + 3，与x轴交于点A，与y轴交于点B，线段AB上有点C，坐标系的标注清晰显示各点位置](./images/image41.png)
...
![图片：图1，坐标系中的线段示意图，包含点A、B、A'、B'等标注](./images/image42.png)
