...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直角三角形ABC，C点为直角顶点，CD垂直于AB，D在AB上
-->  

15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．  
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 矩形ABCD，A在左上角、B在右上角、C在右下角、D在左下角；点E、F分别在矩形内，标注Rt△ABE与Rt△CDF全等关系及各边长信息
-->  

16.（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是___．  
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 扇形OAB，圆心O，弧AB对应的圆心角标注为260°；点A、B、O及内部点P的位置示意
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 点P位于直线l外部，标注直线l和点P的位置示意
-->  
