...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标记点P(-a)、Q(a)、R(1/a)、S(1/a)。
-->  
   A. P  
   B. Q  
   C. R  
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中显示直线y=2x+4，包含原点O，点P在第一象限内
-->
A．1 B．2 C．3 D．4
...
14．（2分）已知反比例函数$y = \frac{6}{x}$，则当$1 ≤ x ≤ 3$时，x的最小值是________．  

15．（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．  
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形ABCD示意图，标注顶点A、B、C、D，Rt△ABE和Rt△CDF的位置关系（E在矩形内，F也在矩形内）
-->  

16．（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是___．  
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 扇形OAB示意图，圆心O，圆心角260°，标注点P在扇形内的位置
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 横轴显示成绩类别（犯规、一般成绩、优秀成绩），纵轴显示次数，甲和乙的数据对应，图中已有部分数据：犯规类甲约3次，乙约1次；一般成绩类甲约4次，乙约3次；优秀成绩类甲约3次，乙约4次
-->  
