...
<!-- IMAGE_PLACEHOLDER
type: 条形统计图
description: 跳远成绩的条形统计图，横轴为成绩类别（犯规、一般成绩、优秀成绩），纵轴为次数。甲在犯规类有3次，一般成绩4次，优秀成绩3次；乙在犯规类1次，一般成绩2次，优秀成绩4次。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 平行四边形ABCD，O为对称中心，连接OA、OB等，BC与圆O相切于E点。左侧提示“可以过点O作AD的垂线……”，右侧提示“也可以连接EO并延长……”。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)，包含圆心O，点A、B在上方，弧AD和弧BC，标注OA长度为9cm，OB长度为6cm，以及相关线段结构
-->
<figure>
  <!-- 这里根据要求，但用户说用占位符单独一行，前后空行？不过按照指示，图片占位符单独占一行，前后各空一行。 -->
</figure>

<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(2)，矩形纸片ABCD，标注边长a和b，其中A、B、C、D为顶点，弧形部分表示扇环的展开形状
-->
<figure>
  <!-- 这里根据要求，但用户说用占位符单独一行，前后空行？不过按照指示，图片占位符单独占一行，前后各空一行。 -->
</figure>
