...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 直角三角形ABC，C为直角顶点，CD垂直AB于D点，标注A、B在底边，C在上方，CD是高
-->  

15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．  
<!-- IMAGE_PLACEHOLDER
type: 矩形示意图
description: 矩形ABCD，对角线AC和BD相交于某点，E、F分别位于对角线上且满足Rt△ABE≌Rt△CDF的条件，标注各顶点和对应点位置
-->  

16.（2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是__．  
<!-- IMAGE_PLACEHOLDER
type: 扇形示意图
description: 扇形OAB，圆心O与端点A、B构成扇形，标注圆心角260°及点P在扇形内的位置关系
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 直线l和外部点P，标注点P的位置及待作的平行线位置关系
-->  
