...
A. <!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 圆锥示意图，显示底面圆和侧面母线
-->
B. <!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 球体示意图，包含虚线表示的赤道
-->
C. <!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 圆台示意图，上下底面为不同大小的圆
-->
D. <!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 圆柱示意图，显示上下底面的圆形和侧面矩形
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 直线a平行于直线b，正六边形ABCDEF的顶点A在直线a上，C在直线b上，标注∠1和∠2的位置
-->
A. 15° B. 20° C. 30° D. 40°  

8．（3分）在平面直角坐标系中，直角三角板AOB按如图位置摆放，直角顶点与原点O重合，点A在反比例函数y = k/x (x>0)的图象上，∠B=30°。若点B坐标为（1，-3），则k的值是（ ）  
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 平面直角坐标系中，直角三角板AOB，O为原点，A在反比例函数y=k/x (x>0)上，∠B=30°，点B坐标(1,-3)
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)显示正方形和观察点P及张角α的示意图；图(2)显示带圆弧的正方形；图(3)显示等边三角形ABC
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 显示△ABC和△ADE的图形，点D在BC上，标注角度和边的关系
-->

20. （8分）一个不透明的盒子里装有四张卡片，分别写有“美”“好”“淮”“安”四个字，卡片除文字外都相同，并将四张卡片充分搅匀。
（1）从盒子中随机抽取1张卡片，恰好抽到“淮”的概率是______；
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 1-8月份A、B型号扫地机器人销售情况条形统计图，横轴为月份（一月到八月），纵轴为销量/台。各月A型（深色柱）和B型（浅色柱）数据：一月A7/B5；二月A17/B8；三月A12/B11；四月A16/B14；五月A19/B12；六月A18/B14；七月A12/B15；八月A17/B11
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图中AB为半圆直径，O为圆心，点D在半圆上，C在AD延长线上，连接BC、BD。标注角度∠CBD=∠CAB，线段AB、AD等几何关系。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸
description: 矩形ABCD示意图，标注各顶点A、B、C、D的位置关系。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形ABCD的示意图，标注顶点A、B、C、D，边AB和BC已知长度
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)示意图，包含矩形MNPQ、雨线AB、角度θ=72°等标注
-->
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(2)示意图，包含手臂前伸的几何关系
-->
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(3)示意图（备用图）
-->
<!-- IMAGE_PLACEHOLDER
type: 备用图
description: 备用图示
...
∴BD-PD=CD-PD=CP．
……
根据小刚的方法，可以得到线段AB、AP、BP、CP的数量关系是 $AB^{2}=AP^{2}+BP·CP$。
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 等腰三角形ABC示意图，A在上方，BC为底边水平，D在BC上且AD垂直BC，P在BC上位于D和C之间（或根据图形位置），标注点B、D、P、C的位置关系
-->
...
[深度思考]（4）如图（4），在△ABC中，∠C=120°，点D、E分别在边AC、BC上，且满足AD=DE=BE，AE、BD交于点P，若tan∠CAE=$\frac{1}{5}$，则$\frac{PA-PE}{PE}$的值为________．

---

<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图形(2)，包含几何图形，点标记为A、B、C、D、F、E，其中∠ACD为直角，四边形CFDE呈现规则形状。
-->
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图形(3)，圆内接三角形ABC，圆心O，连接线段OB、OC、OA等，点D位于BC边上。
-->
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图形(4)，三角形ABC，内部有线段AD、BE交于P点，点D在AC上，E在BC上，DE与AB相交于P。
-->
