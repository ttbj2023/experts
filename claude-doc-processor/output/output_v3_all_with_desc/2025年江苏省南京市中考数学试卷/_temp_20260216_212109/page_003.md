...
<!-- IMAGE_PLACEHOLDER
type: 几何图
description: 直角三角形ABC，C为直角顶点，CD垂直AB于D，标注各边A、B、C、D位置
-->
14.（2分）已知反比例函数$y = \frac{6}{x}$，则当1≤x≤3时，x的最小值是________．

<!-- IMAGE_PLACEHOLDER
type: 几何图
description: 矩形ABCD内，Rt△ABE≌Rt△CDF，标注各顶点A、B、C、D及E、F位置
-->
15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 扇形图
description: 扇形OAB的圆心角为260°，标注点A、B、O及圆心角位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 点P在直线l外，标注直线l和点P位置
-->
