...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标注点P、Q、R、S，分别对应数值 -a、a、$\frac{1}{a}$、1/a？
-->
A. P B. Q C. R D. S
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中显示直线y=2x+4，包含原点O，点P在第一象限内，坐标轴标注x和y
-->
A. 1 B. 2 C. 3 D. 4
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴为“成绩类别”（犯规、一般成绩、优秀成绩），纵轴为“次数”，甲组数据：犯规3次、一般成绩4次、优秀成绩3次；乙组数据：犯规1次、一般成绩4次、优秀成绩4次。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 左侧有“可以通过点O作AD的垂线……”的文字气泡；右侧有“也可以连接EO并延长……”的文字气泡。两个气泡分别对应两位同学的思路提示。
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内有一个圆心为O的圆，圆与边AB相切于点E
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD，A在左下角，B在右下角，C在右上角，D在左上角，动点P在AB边上，三角形ADP阴影部分
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系中A在上方，B在南偏东30°方向，P在中点，C沿正南从A出发，D沿正东从B出发
-->
