...
<!-- IMAGE_PLACEHOLDER
type: 几何图形
description: 直角三角形ABC，点C在上方，A和B在底边两端，CD垂直AB于D点
-->  

15. （2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF。若AB=25，AD=30，AE=15，则EF的长为________。  
<!-- IMAGE_PLACEHOLDER
type: 矩形内的直角三角形示意图
description: 矩形ABCD，点A在左上角，B右上角，C右下角，D左下角。Rt△ABE和Rt△CDF分别在矩形内，E在对角线AC附近，F在对角线BD附近。
-->  

16. （2分）如图，扇形OAB的圆心角为260°，若点P在该扇形内，则∠APB的度数的范围是___。  
<!-- IMAGE_PLACEHOLDER
type: 扇形示意图
description: 扇形OAB，圆心角260°，点A和B在弧的两端，O是圆心。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 点P在直线l外部，需要构造过P且平行于l的直线。
-->  
