...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标记P、Q、R、S四个点，分别对应- a, a, $\frac{1}{a}$的位置，其中P在最左侧，然后是Q（在a处），接着是R（在$\frac{1}{a}$处），最后是S在右侧。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表（条形图）
description: 条形统计图，横轴显示“犯规”“一般成绩”“优秀成绩”三类成绩；纵轴显示次数（0-5）。甲的犯规次数约3次，一般成绩4次，优秀成绩3次；乙的犯规次数1次，一般成绩2次，优秀成绩4次。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 左侧示意图显示过点作AD的垂线；右侧示意图显示连接EO并延长。两个示意图分别对应两种不同的证明思路。
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内有一个圆O，圆与边BC相切于点E，标注各顶点A、B、C、D和圆心O的位置关系
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角，B在右下角，C在右上角，D在左上角，点P在边AB上移动，形成三角形ADP部分展开画面
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系示意图，A在原点，B位于南偏东30°方向40km处，P为AB中点，C沿正南方向从A出发，D沿正东方向从B出发，三点C、P、D共线
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 图(1)，左侧显示一个圆锥侧面展开的扇环，标注A、B点，半径分别为9和6，圆心O，弧AD和BC。右侧图(2)是矩形纸片ABCD的展开图，标注a和b边。
-->  
