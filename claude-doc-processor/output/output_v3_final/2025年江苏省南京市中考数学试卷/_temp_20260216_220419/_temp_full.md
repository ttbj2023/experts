...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标记点P(-a)、Q(a)、R(1/a)和S，各点位置用线段表示，标注清晰
-->
A. P B. Q C. R D. S
...
<!-- IMAGE_PLACEHOLDER
type: 函数图像
description: 坐标系中显示直线y=2x+4，包含原点O，以及点P的位置标注
-->
A. 1 B. 2 C. 3 D. 4
...
<!-- IMAGE_PLACEHOLDER
type: 技术图纸/示意图
description: 圆形古钱币示意图，显示内部有边长10 mm的正方形孔，圆外标注半径相关尺寸7 mm等
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 直角三角形ACB，C点在上方，A和B在底边两端，CD垂直AB于D点，标注各顶点和垂足
-->
14.（2分）已知反比例函数$y = \frac{6}{x}$，则当1≤x≤3时，x的最小值是________．

<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 矩形ABCD，A在左上角，B在左下角，C在右下角，D在右上角。对角线AC和BD相交于某点，E在对角线上靠近A的位置，F在对角线上靠近C的位置，分别有直角符号标注
-->
15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 扇形OAB，圆心O在左上方，A和B分别在左右两端，圆心角260°，弧AB为较大弧
-->
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 点P在直线l外的位置示意图，直线l水平放置，点P在直线上方或下方
-->
...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴显示成绩类别：犯规、一般成绩、优秀成绩；纵轴表示次数。甲的犯规次数约2次，一般成绩约4次，优秀成绩约3次；乙的犯规次数约1次，一般成绩约4次，优秀成绩约4次（根据数据估算）
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD示意图，O为对称中心，连接EO、AD等辅助线。左侧提示“可以通过点O作AD的垂线……”，右侧提示“也可以连接EO并延长……”
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内含圆O，E点在BC边上，标注各顶点A、B、C、D及圆心O的位置
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角，B右下角，C右上角，D左上角，动点P在AB边上，形成三角形ADP区域
-->
...
> <!-- IMAGE_PLACEHOLDER
type: 示意图
description: 坐标系示意图，A在上方，B在南偏东30°方向，P是AB中点，C从A正南出发，D从B正东出发，C、P、D三点共线
-->
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 纸杯展开图，包含两个同心圆弧AD和BC，标注半径9、6，以及中心点O，A、B、C、D的位置
--> 
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形纸片示意图，标注长为b、宽为a，包含弧线AB和CD等
--> 
