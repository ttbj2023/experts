...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 数轴示意图，从左到右依次标记P(-a)、Q(a)、R(1/a)和S的位置，各点用小黑点表示
-->
A. P B. Q C. R D. S
