...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD，A在左下角，B在右下角，C在右上角，D在左上角；点P在AB边上移动，形成三角形ADP区域（画面展开部分），标注各边长及运动路径
-->
...
<!-- IMAGE_PLACEHOLDER
type: 方位示意图
description: 以A为原点，北为向上方向，东为右方；标注A、B位置（B在A南偏东30°），AB连线，P在中点；C从A正南方向出发，D从B正东方向出发，连接CP、PD形成直线关系
-->
