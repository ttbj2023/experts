...
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 直角三角形ABC，其中∠C为直角，线段CD垂直于AB交于点D，标注顶点A、B、C、D的位置
-->
14.（2分）已知反比例函数$y=\frac{6}{x}$，则当1≤x≤3时，x的最小值是________．

<!-- IMAGE_PLACEHOLDER
type: 图形
description: 矩形ABCD内包含Rt△ABE和Rt△CDF，两直角三角形全等，标注各顶点及对应关系
-->
15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 图形
description: 扇形OAB，圆心角∠AOB=260°，标注点A、B和圆心O的位置
-->
...
<!-- IMAGE_PLACEHOLDER
type: 图形
description: 点P在直线l外的示意图，显示点P和直线l的位置关系
-->
