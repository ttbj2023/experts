...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 直角三角形ABC，C点在上方，CD垂直AB于D点，标注各顶点A、B、C、D
-->
14.（2分）已知反比例函数$y = \frac{6}{x}$，则当1≤x≤3时，x的最小值是________．

<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 矩形ABCD内Rt△ABE≌Rt△CDF的示意图，标注矩形各顶点A、B、C、D，以及全等的两个直角三角形
-->
15.（2分）如图，点E，F在矩形ABCD内，Rt△ABE≌Rt△CDF．若AB=25，AD=30，AE=15，则EF的长为________．

<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 扇形OAB的示意图，圆心角260°，标注圆心O、端点A和B，以及扇形内部一点P的位置
-->
