...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 平行四边形ABCD内含圆O，点E在BC边上，标注各顶点A、B、C、D及圆心O和切点位置
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 长方形ABCD示意图，A在左下角、B右下角、C右上角、D左上角，动点P在AB边上，三角形ADP为展开的画面（阴影部分）
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 示意图
description: 方位图包含北东方向箭头，A点位置、B在南偏东30°处，AB连线，P为AB中点，C从A正南出发，D从B正东出发，连接CP和PD显示共线关系
-->  
