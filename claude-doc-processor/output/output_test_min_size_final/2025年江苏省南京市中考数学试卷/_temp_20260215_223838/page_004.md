...
<!-- IMAGE_PLACEHOLDER
type: 统计图表
description: 条形统计图，横轴显示成绩类别（犯规、一般成绩、优秀成绩），纵轴显示次数。甲的犯规约3次，一般成绩4次，优秀成绩3次；乙的犯规1次，一般成绩2次，优秀成绩4次。
-->  
...
<!-- IMAGE_PLACEHOLDER
type: 几何示意图
description: 平行四边形ABCD，O为对称中心（对角线交点），BC与圆O相切于E点。图中显示两种思路：过点A作AD的垂线或连接EO并延长。
-->